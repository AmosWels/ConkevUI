...
<div class="card card-transparent no-m">
    <div class="card-content invoice-relative-content search-results-container">
                            ...
                            <div class="card">
                                <div class="card-content">
                                    <div class="search-result">
                                        <span href="#" class="search-result-title" style="font-size: 16px;">PEP?</span>
                                        ...
                                        <div class="right">
                                            ...
                                            <label for="nmatch" style="color:">No</label>
                                            <input type="radio" id="match" name="compare" class="validate with-gap">
                                            <label for="match" style="">Yes</label></div>
                                    </div><hr width="100%" size="1"><br>

                                    <div class="search-result">
                                        <span href="#" class="search-result-title" style="font-size: 16px;">Resident Outside Uganda?</span>
                                        <p class="search-result-description">
                                            <span style="font-weight: bold;">Name:</span> Joseph Kony | 
                                            <span style="font-weight: bold;">Gender:</span> Male |
                                            <span style="font-weight: bold;">Nationality:</span> Ugandan | 
                                        ...
                                        <div class="right">
                                            ...
                                            <label for="nmatch1" >No</label>
                                            <input type="radio" id="match2" name="compare1" class="validate with-gap">
                                            <label for="match2" >Yes</label></div>
                                    </div><hr width="100%" size="1"><br>
                                    <div class="search-result">
                                        <span href="#" class="search-result-title" style="font-size: 16px;">Resident Inside Uganda?</span>
                                        <p class="search-result-description">
                                            <span style="font-weight: bold;">Name:</span> Joseph Kony | 
                                            <span style="font-weight: bold;">Gender:</span> Male |
                                            <span style="font-weight: bold;">Nationality:</span> Ugandan | 
                                        ...
                                        <div class="right">
                                            <input type="radio" id="nmatch3" name="compare2" class="validate with-gap">
                                            <label for="nmatch3" >No</label>
                                            <input type="radio" id="match4" name="compare2" class="validate with-gap">
                                            <label for="match4">Yes</label></div>
                                    </div><hr width="100%" size="1"><br>
                                    <div class="search-result">
                                        <span href="#" class="search-result-title" style="font-size: 16px;">Foreign PEP?</span>
                                        <p class="search-result-description">
                                            <span style="font-weight: bold;">Name:</span> Joseph Kony | 
                                            <span style="font-weight: bold;">Gender:</span> Male |
                                            <span style="font-weight: bold;">Nationality:</span> Ugandan | 
                                        ...
                                        <div class="right">
                                            <input type="radio" id="nmatch5" name="compare3" class="validate with-gap">
                                            <label for="nmatch5" >No</label>
                                            <input type="radio" id="match6" name="compare3" class="validate with-gap">
                                            <label for="match6">Yes</label></div>
                                    </div><hr width="100%" size="1"><br>
                                    <div class="search-result">
                                        <span href="#" class="search-result-title" style="font-size: 16px;">Natural Person and Resident outside Uganda</span>
                                        <p class="search-result-description">
                                            <span style="font-weight: bold;">Name:</span> Joseph Kony | 
                                            <span style="font-weight: bold;">Gender:</span> Male |
                                            <span style="font-weight: bold;">Nationality:</span> Ugandan | 
                                        ...
                                        <div class="right">
                                            <input type="radio" id="nmatch6" name="compare4" class="validate with-gap">
                                            <label for="nmatch6" >No</label>
                                            <input type="radio" id="match7" name="compare4" class="validate with-gap">
                                            <label for="match7" ">Yes</label></div>
                                    </div><hr width="100%" size="1"><br>
                                    <br>
        ...
        <?php
        include_once 'Modal/modalnewcustomer/Sanctionmodals.php';
        ?>
