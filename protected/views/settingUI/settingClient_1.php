                            ...
                            <div class="col s12 m6 20">
                                <div class="indicator" style="right: 420px; left: 0px;">
                                    <ul class="tabs tabs-demo z-depth-0" style="width: 100%;">
                                        <!--<li class="tab col s3"><a href="#info" class="active">SDD CLIENT</a></li>-->
                                        <li class="tab col s3"><a href="#info" class="active">Drafts<span>&nbsp;&nbsp;&nbsp;(3)</span></a></li>
                                        <!--<li class="tab col s3"><a href="#approved" class="">INBOX <span class="right">2</span></a></li>-->
                                        <li class="tab col s3"><a href="#approved">inbox<span>&nbsp;&nbsp;&nbsp;(2)</span></a></li>
                                        <!--<li class="tab col s3"><a href="#approved" class="">APPROVED</a></li>-->
                                        <!--<li class="tab col s3"><a href="#acc">SDD ACCOUNT</a></li>-->
                                        <li class="tab col s3"><a href="#review">APPROVED<span>&nbsp;&nbsp;&nbsp;(3)</span></a> </li>
<!--                                                        <li class="tab col s3"><a href="#rejected" class="">REJECTED</a></li>
                                        <li class="tab col s3 disabled"><a href="#res" class="">Resources</a></li>                                                    -->
                                    </ul>
                                </div>
                            </div>
                            <!--                                            <div class="col s12 m4 20 right-align search-stats">
                                    ...
                                    <div class="card-content">
                                        <div class="tabs-vertical">
                                            <ul class="tabs z-depth-0">
                                                <p class="m-t-lg flow-text">Client Types</p>
                                                <li class="tab">
                                        ...
                                        <br/><br/>
                                        <!--<a href="#all_info">-->
                                           <a href="<?php echo @Yii::app()->baseUrl; ?>/index.php?r=settingUI/AllSettingClientInfoReq"><span style="color: gray; text-decoration: underline;" 
                                                                              class="tooltipped" data-position="top" data-delay="50" data-tooltip="View/Edit/Delete">Information Requirements</span>
                                            </a> 
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col s12 m9">
                            <div id="cminor">
                                <div class="card" style="height: 585px;">
                                    <div class="card-content ">
                                        <!--<div id="ccontainer" style="min-width: 310px; height: 400px; margin: 0 auto"></div>-->
                                        <ol class="collection">
                                        <!--<ol class="collapsible popout collapsible-accordion" data-collapsible="accordion">-->
                                                <li> 
                                                    <a href="<?php echo @Yii::app()->baseUrl; ?>/index.php?r=settingUI/settingClientInfo"><div class="collection-item" ><span style="font-size: 16px; color: gray">Identification</span>
                                                            <span class="right" style="color: gray" >Identification of Client</span></div></a>
                                                </li> 
                                        </ol>
                                    </div>
                                </div>
...
<!--                                                                                    <div class="col m2">
                ...
                <!--Start of Resources tab-->
                <div id="res" class="col s12 m12 l12" style="display: none;">
                    <div class="row">
                        <div class="collection s12 m4 14">
                            <a href="#" class="collection-item collapsible-header">Minutes<span class="badge" data-badge-caption="Feb 12"></span></a>
                        ...
                        <div class="fixed-action-btn" style="bottom: 15px; right: 24px;">
                            ...
                            <ul>
                                <li><a class="btn-floating yellow darken-1waves-effectwaves-effect waves-light red modal-trigger" href="#create_resource2" style="transform: scaleY(0.4) scaleX(0.4) translateY(40px) translateX(0px); opacity: 0;"><i class="material-icons">folder</i></a></li>
                                <li><a class="btn-floating greenwaves-effectwaves-effect waves-light red modal-trigger" href="#create_doc2" style="transform: scaleY(0.4) scaleX(0.4) translateY(40px) translateX(0px); opacity: 0;"><i class="material-icons">attach_file</i></a></li>
                                <li><a class="btn-floating blue bluewaves-effectwaves-effect waves-light red modal-trigger" href="#create_info2" style="transform: scaleY(0.4) scaleX(0.4) translateY(40px) translateX(0px); opacity: 0;"><i class="material-icons">add</i></a></li>
                            </ul>
                        </div>
                        <!--Create New Resource-->
                        <div id="create_resource2" class="modal modal-content">
                            <h5>Enter Resource Name</h5>
                            <div class="row">
