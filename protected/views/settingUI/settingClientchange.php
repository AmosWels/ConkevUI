                            ...
                            <div class="col s12 m12 l10 left">
                                <h5 class="" style="font-size: 16px">
                                    <div class="breadcrumbs">
                                        <span>Settings>>Customer SDD</span>
                                    </div>
                                </h5>
                            </div>
                        </div>
                                ...
                                <div class="card-content">
                                    <div class="tabs-vertical">
                                        <ul class="tabs z-depth-0 transparent">
                                            <li class="tab">
                                                <a class="active" href="#na">Nationality<span>&nbsp;&nbsp;&nbsp;(3)</span></a> 
                                            </li>
                                            <li class="tab">
                                                <a href="#ide">Identification<span>&nbsp;&nbsp;&nbsp;(3)</span></a> 
                                            </li>
                                            <li class="tab">
                                                <a href="#dob">Date Of Birth<span>&nbsp;&nbsp;&nbsp;(2)</span></a> 
                                            </li>
                                            <li class="tab">
                                                <a href="#ge">Gender<span>&nbsp;&nbsp;&nbsp;(3)</span></a> 
                                            </li>
                                            <li class="tab">
                                                <a href="#cog">Country Of Origin<span>&nbsp;&nbsp;&nbsp;(5)</span></a> 
                                            </li>
                                            <li class="tab">
                                                <a href="#poo">Place of Origin<span>&nbsp;&nbsp;&nbsp;(0)</span></a> 
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div id="na" class="card grey lighten-4">                            
                                <div class="card-content">
                                    ...
                                    <div class="row s12 search-stats">
                                        <span class="m-r-sm left-align">Nationality</span><span class="m-r-sm right-align">The actual country of birth of the client considering the place of birth</span><a href="#edit_info" class="modal-trigger"><i class="material-icons tiny tooltipped" data-position="top" data-delay="50" data-tooltip="Edit Information Requirement">edit</i></a>
                                    </div>
                                    <div class="row s12">
                                        ...
                                        <div class="col s12 m4 l4">
                                            <div class="card stats-card">
                                                <div class="card-content">
                                                    ...
                                                    <a href="#accopendocs" class="modal-trigger tooltipped" data-position="left" data-delay="50" data-tooltip="Add / View / Edit"><span>Document Types</span></a><span class="right">(2)</span><br/>
                                                    <a href="#question" class="modal-trigger tooltipped" data-position="left" data-delay="50" data-tooltip="Add / View / Edit"><span>Questionnaire</span></a><span class="right">(2)</span><br/>
                                                    <a href="#externaldata1" class="modal-trigger tooltipped" data-position="left" data-delay="50" data-tooltip="View"><span>External System Data</a><span class="right">(2)</span></span><br/>
                                                </div>
            ...
            <form>
                <div class="modal-content">
                    <div class="card">
                        <div class="card-content">
                            <div class="row s12">
                                <h5>Information from External System</h5>
                                <div class="col s3">
                                    <input type="checkbox" id="ci">
                                    <label for="ci">Citizen ID</label>
                                </div>
                                <div class="col s3">
                                    <input type="checkbox" id="coN">
                                    <label for="coN">Conkev_Created_on</label>
                                </div>
                                <div class="col s3">
                                    <input type="checkbox" id="nna">
                                    <label for="nna">Nationality</label>
                                </div>
                                <div class="col s3">
                            ...
                            <div class="row s12">
                                <div class="col s3">
                                    <input type="radio" name="ext" id="cir">
                                    <label for="cir">Citizen ID</label>
                                </div>
                                <div class="col s3">
                                    <input type="radio" name="ext" id="coNr">
                                    <label for="coNr">Conkev_Created_on</label>
                                </div>
                                <div class="col s3">
                                    <input type="radio" name="ext" id="nnar">
                                    <label for="nnar">Nationality</label>
                                </div>
                                <div class="col s3">
                                    <input type="radio" name="ext" id="RIMr">
                                    <label for="RIMr">RIM</label>
                                </div>
                            </div>
                        </div>                                 
                    </div>
                ...
                <div class="form-group"> 
                    <div class="modal-footer">
                        <a href="#" class="modal-action modal-close waves-effect waves-blue btn blue ">Save</a>
                        <a href="#" class="modal-action modal-close waves-effect waves-blue btn-flat ">Close</a>
                    </div>
                </div>
            </form>
        </div>
        <div id="externaldata1" class="modal modal-footer">
            <form>
                <div class="modal-content">
                    <div class="card">
                        <div class="card-content">
                            <div class="row s12">
                                ...
                                <div class="col s3">
                                    ...
                                    <label for="ci1">Relationship ID</label>
                                </div>
                                <div class="col s3">
                                    <input type="checkbox" id="coN1">
                                    <label for="coN1">Relative Name</label>
                                </div>
                                <div class="col s3">
                                    <input type="checkbox" id="nna1">
                                    <label for="nna1">Relation Type</label>
                                </div>
                                <div class="col s3">
                                    <input type="checkbox" id="RIM1">
                                    <label for="RIM1">RIM</label>
                                </div>
                            </div>
                            <div class="row s12">
                                <div class="col s3">
                                    <input type="radio" name="ext1" id="cir1">
                                    <label for="cir1">Relationship ID</label>
                                </div>
                                <div class="col s3">
                                    <input type="radio" name="ext1" id="coNr1">
                                    <label for="coNr1">Relative Name</label>
                                </div>
                                <div class="col s3">
                                    <input type="radio" name="ext1" id="nnar1">
                                    <label for="nnar1">Relation Type</label>
                                </div>
                                <div class="col s3">
                                    <input type="radio" name="ext1" id="RIMr1">
                                    <label for="RIMr1">RIM</label>
                                </div>
                            </div>
                        </div>                                 
                    </div>
