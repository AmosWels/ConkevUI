                            ...
                            <div class="col s12 m12 l10 left">
                                <h5 class="" style="font-size: 16px">
                                    <div class="breadcrumbs">
                                        <span>Settings>>New customer</span>
                                    </div>
                                </h5>
                            </div>
                        </div>
        ...
        <div class="col s12 m12 l12">
            <div class="search-page-results">
                ...
                <div id="drafts" class="row s12 m12">
                    ...
                    <div class="col s12 m9">
                            ...
                            <div class="card">
                                <div class="card-content">
                                    <table id="new_client_data" class="display responsive-table datatable-example">
                                        ...
                                        <tbody>  
                                            <tr onclick="location.href = '<?php echo @Yii::app()->baseUrl; ?>/index.php?r=settingUI/NewCustomerInfo18sept'">
                                                <td>Mwesigye John Bosco </td>
                                                <td>2910829108291082</td>
                                                <td>Minor</td>
                        ...
                        <div id="prospect">
                            <div class="card">
                                <div class="card-content">
                                    <table id="new_client_prospect" class="display responsive-table datatable-example">
                                        <thead>
                                            <tr>
                ...
                <div id="inbox">
                    <div class="card">
                        <div class="card-content">
                            <table id="inbox_new_client" class="display responsive-table datatable-example">
                                <thead>
                                    <tr>
                                        <th>Client Names</th>
                                        <th>Rim Number</th>                                            
