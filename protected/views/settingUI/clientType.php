...
//                                                    if(!empty($requirement->clienttypes)){
//                                                        $count_types = count(explode(',', $requirement->clienttypes));
//                                                    }else{ $count_types = 0;}
                                            ?>
                                            <li class="tab">
                                                <a href="#<?php echo $requirement->id;?>"><?php echo $requirement->name; ?>
                                                    <span>&nbsp;&nbsp;&nbsp;(<?php //echo $count_types;?>)</span>
                                                </a> 
                                            </li>
                                             <?php
                                                $r++; } }
...
//map document type
include_once 'modalsCustomer/mapDocument.php';
